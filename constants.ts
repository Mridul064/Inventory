...
export const PERMISSION_LIST: { id: Permission; label: string; group: 'Inventory' | 'Movement' | 'Indents' | 'Reporting' | 'AI' | 'System' }[] = [
  // General Ledger
  ...
  { id: 'STOCK_IN', label: 'Post Material Receipt (Entry)', group: 'Movement' },
  { id: 'STOCK_OUT', label: 'Authorize Stock Issuance', group: 'Movement' },
